  ...
  <main>
    <div class="pt-3 w-75 m-auto">
      ...
      <section class="row m-auto">
        <form action="filtrage.php" method="POST" class="d-flex">
          <div class="mt-2">
            <label for="categories_1">Shonen</label>
            <input type="checkbox" name="categories_1" value="1">
          </div>
          <div class="mt-2 mx-2">
            <label for="categories_1">Shojo</label>
            <input type="checkbox" name="categories_1" value="2">
          </div>
        ...
        <?php while ($article = $requete->fetch(PDO::FETCH_ASSOC)) { ?>
          <div class="col-sm-6 col-md-4 ">
            <div class="card py-1 mt-3">
              ...
              <?php if(estConnecte() && estAdmin()) { ?>
            <p>     
                    <a href="crud/suppr-produit.php?action=suppression&id=<?php echo $article['id_produit'] ?>" class="btn btn-outline-danger" onclick="return(confirm('Etes-vous sûr de vouloir supprimer cet article?'))">
                    ...
                    <a href="crud/modif-produit.php?id=<?php echo $article['id_produit'] ?>" class="btn btn-outline-warning"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
