...
<body>
  ...
  <main>
    <div class="pt-3 w-75 m-auto">
      <h2>Manga</h2>
      <p><a href="" class="btn btn-success">Ajouter un produit</a></p>
      ...
      <h4 class="card-title"><a href="articleProduit.php?id_produit=' . $article['id_produit'] . '">' . $article['titre'] . '</a></h4>
        ...
        <p class="card-text">' . html_entity_decode(substr($article['description'], 0, 100)) . '</p>';
          ...
          if (estConnecte() && estAdmin()) {
            echo '<p> 
                    <a href="supprimer-article.php?action=suppression&id_article=' . $article['id_produit'] . '" class="btn btn-danger" onclick="return(confirm(\'Etes-vous sûr de vouloir supprimer cet article?\'))">
                    ...
                    <a href="modif-produit.php?id=' . $article['id_produit'] . '" class="btn btn-warning"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
